# [1.2.0](https://github.com/adriana-carmo/treetracker-web-map-client/compare/v1.1.0...v1.2.0) (2021-07-08)


### Bug Fixes

* 60 issue - show timeline icon when sidepanel is open ([532bede](https://github.com/adriana-carmo/treetracker-web-map-client/commit/532bede376c6505b143053b31e83d5f8b75775b4))
* change round to floor, to keep consistant with tile server ([9848351](https://github.com/adriana-carmo/treetracker-web-map-client/commit/98483518071978684519e919a5459386148ec289))
* fix files with ESLint and Prettier rules ([c4ef7c2](https://github.com/adriana-carmo/treetracker-web-map-client/commit/c4ef7c2dd2dc7465449f630e990dbb4af1b584da))
* fix files with ESLint and Prettier rules ([46e4288](https://github.com/adriana-carmo/treetracker-web-map-client/commit/46e4288254943736fa6ab51b88f8838ac618b3d3))
* handle no tree case ([cbd3d76](https://github.com/adriana-carmo/treetracker-web-map-client/commit/cbd3d7633f51dfc7f47654af82dd37c4f2c33a45))
...
* restore village name ([546b5e0](https://github.com/adriana-carmo/treetracker-web-map-client/commit/546b5e01fb55b6a5a4c48fbae6ab04401a3f9dd2))
* sort out utf lib name; ([75adc6a](https://github.com/adriana-carmo/treetracker-web-map-client/commit/75adc6a09f05572daad0dd05945279f7f1e72b1f))
* sort out utf lib name; ([779eebf](https://github.com/adriana-carmo/treetracker-web-map-client/commit/779eebfdfdac04c048939ceda4377620f8e29129))
* the aerial image would cover the cluster points ([6bf609e](https://github.com/adriana-carmo/treetracker-web-map-client/commit/6bf609ee2902389ee4b51ef064cc290cb6bf8eb9))
* the aerial image would cover the cluster points ([45eda86](https://github.com/adriana-carmo/treetracker-web-map-client/commit/45eda86f786bf9a97a03f5db692b3ace81c2f788))
* tree name case can not zoom in ([7dbe64c](https://github.com/adriana-carmo/treetracker-web-map-client/commit/7dbe64cf77d5c5d6e5cb6d987fa8084e571af1ba))


### Features

* add fixture for cy ([09beae1](https://github.com/adriana-carmo/treetracker-web-map-client/commit/09beae1c78383b82a2f85150348ccb4c195c2039))
* add freetown special layer ([e95f49f](https://github.com/adriana-carmo/treetracker-web-map-client/commit/e95f49fcb0bd18f6767a1ced88dc1237c05ba20e))
* can calculate org map initial view ([3c35918](https://github.com/adriana-carmo/treetracker-web-map-client/commit/3c35918fea90d66acefb25d44aa8adc4510b6356))
* can click and show tree panel ([89b09c4](https://github.com/adriana-carmo/treetracker-web-map-client/commit/89b09c49d45cb51271330cd28cec5aa85ce07250))
* can click cluster and zoom in ([7a54536](https://github.com/adriana-carmo/treetracker-web-map-client/commit/7a54536eb34e99212e1ed68074b9a061e76b675e))
* can click cluster to zoom in ([5d35578](https://github.com/adriana-carmo/treetracker-web-map-client/commit/5d355780af697bbc8e669bb36bcda9a24788ff53))
* can click next/prev ([83fe63f](https://github.com/adriana-carmo/treetracker-web-map-client/commit/83fe63ff3657f4ec3953e543aae466ac595f4aee))
* can dispay error message ([c6c49d9](https://github.com/adriana-carmo/treetracker-web-map-client/commit/c6c49d926c5b64083c2a0b72908277adc0401aa2))
* can display cluster highlight ([e34eb79](https://github.com/adriana-carmo/treetracker-web-map-client/commit/e34eb7967d05c8d89c4ae7015e38213e3d0415b9))
* can display first cluster tile ([8e751f6](https://github.com/adriana-carmo/treetracker-web-map-client/commit/8e751f6112d502057adc4e0e22ac67b503ebc1fc))
* can display free highlight ([a22c6b1](https://github.com/adriana-carmo/treetracker-web-map-client/commit/a22c6b1bd2a3636e230f5f05fbaa25022ed8d07f))
* can display single tree ([a8b37f0](https://github.com/adriana-carmo/treetracker-web-map-client/commit/a8b37f0e213093c7887692d00c57eb4740d504d3))
* can highlight cluster ([3f5f055](https://github.com/adriana-carmo/treetracker-web-map-client/commit/3f5f0551c654484e39200e7797d894683fdd8ed9))
* can load bounds from url ([322f40e](https://github.com/adriana-carmo/treetracker-web-map-client/commit/322f40ef9605898790ba3afecb196f562cf2bff2))
* can load cluster ([120b6d7](https://github.com/adriana-carmo/treetracker-web-map-client/commit/120b6d77d560d90a4899a918be4785aee4b75720))
* can load map(google) ([f9a6780](https://github.com/adriana-carmo/treetracker-web-map-client/commit/f9a6780a8d34f4790e1cc62e83addd0f27a10520))
* can reqeust ?tree_name=xxx now ([fe8a4e9](https://github.com/adriana-carmo/treetracker-web-map-client/commit/fe8a4e9601d99a7af02d6421ff33e2a79713d53c))
* can select the tree marker ([b9eeaaa](https://github.com/adriana-carmo/treetracker-web-map-client/commit/b9eeaaa8cb7e31befe4dfdd021cf5b3ff5596e47))
* can show nearest arrow, and click ([eb1e4ab](https://github.com/adriana-carmo/treetracker-web-map-client/commit/eb1e4abb6efbc3b34376dc519d30e431f3ac349e))
* can use zoome_target ([15b85af](https://github.com/adriana-carmo/treetracker-web-map-client/commit/15b85af6ac789f805a2375d2fe14096f8b9112cf))
* can zoom in by click cluster ([ee1fb2c](https://github.com/adriana-carmo/treetracker-web-map-client/commit/ee1fb2ca3c063e5b673feaecfe5937cbce6539d4))
* can zoom in cluster ([bb62de6](https://github.com/adriana-carmo/treetracker-web-map-client/commit/bb62de68a2e8dc7de8c6fd2ae779ca9cd2bfc10f))
* control ([5f4979e](https://github.com/adriana-carmo/treetracker-web-map-client/commit/5f4979ed31f58860e1b763637e1b16a6ced7b1ae))
* display two kind of cluster icon ([6b4a911](https://github.com/adriana-carmo/treetracker-web-map-client/commit/6b4a911288f2b669da6029520b4fa39b54625f95))
* merge control the display of geojson in freetown, merge from old version ([2df2ade](https://github.com/adriana-carmo/treetracker-web-map-client/commit/2df2aded5c9372b9b97138f6c12c6387397481ec))
* merge ocean black box fixing from old version to new ([b7b8151](https://github.com/adriana-carmo/treetracker-web-map-client/commit/b7b81515e98687ef896b2658532cd917881aefaa))
* moreEffect config ([0115899](https://github.com/adriana-carmo/treetracker-web-map-client/commit/01158997b1d356297a7f82923b8be7218641cadf))
* support: freetown.treetracker.org ([4a54e69](https://github.com/adriana-carmo/treetracker-web-map-client/commit/4a54e692cd80643ad38fd3827b7ebe5d7bc22b80))
* tile debugger ([e879d4f](https://github.com/adriana-carmo/treetracker-web-map-client/commit/e879d4ffb586efdd9f5d361af31d0f4a188fedf1))

# [1.2.0](https://github.com/adriana-carmo/treetracker-web-map-client/compare/v1.1.0...v1.2.0) (2021-06-22)
...
* restore city namp on the map ([9f03928](https://github.com/Greenstand/treetracker-web-map-client/commit/9f039289d2a0855fde6d4d40e09249ac3a6de0da))

# [1.1.0](https://github.com/adriana-carmo/treetracker-web-map-client/compare/v1.0.1...v1.1.0) (2021-04-14)


### Bug Fixes

* do not load tile server ([863aba6](https://github.com/adriana-carmo/treetracker-web-map-client/commit/863aba668370b7174e1506667a63cb92592b4807))
* extra slash ([6cdc0d0](https://github.com/adriana-carmo/treetracker-web-map-client/commit/6cdc0d0a016af6a37f38421db156298a5e26fbd7))
* incorrectly displaying icons in some zoomlevel ([377b697](https://github.com/adriana-carmo/treetracker-web-map-client/commit/377b697efc3d3439f7631c79b83289bf1856fef6))
* missed slash ([1e8d6a4](https://github.com/adriana-carmo/treetracker-web-map-client/commit/1e8d6a47bc8cfecc59df39d58d16c509bd11da92))
* remove the map bounds url update for now ([87fda83](https://github.com/adriana-carmo/treetracker-web-map-client/commit/87fda83281339ee141fa88d39d937dea3a519c0d))
* restore https://github.com/Greenstand/treetracker-web-map-api/pull/300/files ([8f8cc8c](https://github.com/adriana-carmo/treetracker-web-map-client/commit/8f8cc8c56f4f084f1fe48b88a0800d0b51628287))
* restore https://github.com/Greenstand/treetracker-web-map-api/pull/304/files ([6c545c8](https://github.com/adriana-carmo/treetracker-web-map-client/commit/6c545c84bd5b9ebc7fda5f1dace70a420b353c23))
* treeid=xxx fails ([412f424](https://github.com/adriana-carmo/treetracker-web-map-client/commit/412f4246fa6e8cfa0e8de1fe8bf2c4d8a6ccc737))
* wrong selected icon position ([32cf20e](https://github.com/adriana-carmo/treetracker-web-map-client/commit/32cf20e697ceec2057bdd449b726d92891966a06))


### Features

* can display map with leaflet, (new code) ([d515804](https://github.com/adriana-carmo/treetracker-web-map-client/commit/d515804f6d0f0704b14013f76417115b73e650af))
* can show selected tree icon ([a55ddf4](https://github.com/adriana-carmo/treetracker-web-map-client/commit/a55ddf423bc86d987bd083daaddd6d390af235de))
* fix two point problem ([36b840b](https://github.com/adriana-carmo/treetracker-web-map-client/commit/36b840b98e886caeebdb81d0ecc5156631aeee2b))
* freetown map use special tile ([e25976c](https://github.com/adriana-carmo/treetracker-web-map-client/commit/e25976c0c0e36e2015538d0cbaafcf06d13d33e1))
* freetown org name use tile server ([44cbbf7](https://github.com/adriana-carmo/treetracker-web-map-client/commit/44cbbf77358e4f311d91238f972395bb69f92f56))
* restored next/prev tree in tile version ([3f1894e](https://github.com/adriana-carmo/treetracker-web-map-client/commit/3f1894e2968f356106d52d770e3c98c2a2ef19f6))
* solved the treeid=xxx problem ([2b16855](https://github.com/adriana-carmo/treetracker-web-map-client/commit/2b16855f300afe8091dcfabec0fc2c5821b8e7ab))
...
* can show selected tree icon ([a55ddf4](https://github.com/Greenstand/treetracker-web-map-client/commit/a55ddf423bc86d987bd083daaddd6d390af235de))
...
* bug in the new repo structure, will lead to fail when start 'npm start' ([40c1825](https://github.com/Greenstand/treetracker-web-map-client/commit/40c1825a4923a4b722f63bdb3f12735da5b21556))
...
* complete code migration ([7e10770](https://github.com/Greenstand/treetracker-web-map-client/commit/7e10770d8b3f9778f26efcdaa63e6ac2ca46e262))
